...
public:
    ...
    bool operator>=(Large_number Lg)
    {
        if(content.length()>Lg.get().length())
            return true;
        if(content.length()<Lg.get().length())
            return false;
        for(int i=0;i<content.length();i++)
        {
            if(int(content[i])>int(Lg.get().length()))
                return true;
            if(int(content[i])<int(Lg.get().length()))
                return false;
        }
...
int main()
{
    Large_number Lg1("123456777890");
    Large_number Lg2("16234137466254167345721437235157237532756417234672314572154");
    cout<<"zbir "<<(Lg1+Lg2).get()<<endl;
    cout<<"razlika "<<(Lg1-Lg2).get()<<endl;
    cout<<"proizvod "<<(Lg1*Lg2).get()<<endl;
}